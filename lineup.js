var lineup = {
    ...
    'TRAILER PARK': [{
        'THE MOBILE HOME STAGE': ['THE YOUNG FOLK',
            'THE WHEREABOUTS',
        ...
        'JIMMIE LEE\'S JUKE JOINT': ['ERIC BUTLER AND THE REVELATORS',
    ...
    'TRENCHTOWN': [{
        'MAIN STAGE INNA LIVE YARD': ['SOLO BANTON',
        ...
        'ROOTS INNA DA WOODS ARENA': ['REVELATION SOUND SYSTEM',
            'MIALODICA',
            'BENJI REVALATION',
        ...
        'TREASURE BEACH STAGE': ['WILL SOFTLY',
            'DAVE BARRY',
            'SLICK NORMAL',
            'NIGEL WOODS'
        ],
        'RED BULL MUSIC ACADEMY': ['BODDIKA',
            'JOY ORBISON',
            'DARK SKY',
            'SUNIL SHARPE',
            'DORIAN CONCEPT',
        ...
        'CASA BACARDI': ['DIMITRI FROM PARIS',
            'GREG WILSON',
            'THE 2 BEARS',
            'NANCY WHANG',
            'EJECA',
        ...
        'JERRY FISH ELECTRIC SIDESHOW': ['SALLY CINNAMON',
